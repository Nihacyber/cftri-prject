  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 p-4 md:p-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex items-center text-gray-600">
                {/* You can show coordinator name/email here if available */}
      ...
      <main className="space-y-6">
                          ...
                          <div className="mt-4 pl-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-gray-800">
                                      {(user.onboarding?.details?.collaborativeOptions &&
                                        user.onboarding.details.collaborativeOptions.length > 0)
                                ...
                                <>
                                  <div className="flex items-start">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-gray-800">
                                        {user.onboarding?.details?.discussionMatter || "Not provided"}
                                      </p>
                                    </div>
                                  </div>
                                  <div className="flex items-start">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-gray-800">
                                        {user.onboarding?.details?.specificOption || "Not provided"}
                                      </p>
                                    </div>
                                  </div>
                                </>
                              ...
                              <div className="flex items-start">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-800">
                                    {user.onboarding?.details?.type || "Not provided"}
                                  </p>
                                </div>
                              </div>
                              <div className="flex items-start">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-800">
                                    {user.onboarding?.details?.category || "Not provided"}
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex space-x-2">
                              {editingStatus === user._id ? (
                                ...
                                <button
                                  onClick={() => handleStatusChange(user._id, user.taskStatus)}
                  ...
                  {visibleUsers < users.length && (
                    <div className="text-center py-4">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Showing {Math.min(visibleUsers, users.length)} of {users.length} users
                      </p>
                    </div>
                  )}
                </>
        ...
        {/* Uncomment and use this block if you want to enable the techTransfer tab */}
        {/* 
        {activeTab === "techTransfer" && (
          <div className="space-y-6 bg-white rounded-xl shadow-md p-6">
            ...tech transfer content...
          </div>
        )}
        */}
      </main>
