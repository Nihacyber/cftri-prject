...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      // Only send role for dean, otherwise send full formData
      const payload = formData.role === "dean"
        ? { role: "dean" }
        : formData;
    ...
    switch (role) {
      ...
      case "dean":
        return {
          ...
          roleName: "Dean",
          Icon: HelpCircle, // or any icon you prefer
          roleDescription: "Dean dashboard access",
